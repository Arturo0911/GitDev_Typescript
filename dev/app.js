...
class App {
    // inicializamos el constructor que tomará los puertos
    constructor(port) {
        this.port = port;
        // o caso contrario que se coloque el puerto de tipo string
        Passportconfig;
        this.app = express_1.default();
        this.port_settings();
        this.middlewares(); // como sabemos todo constructor
        // realiza el proceso una vez que se crea la clase
